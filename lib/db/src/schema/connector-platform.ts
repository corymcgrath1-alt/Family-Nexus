...
export const connectorSyncCheckpointsTable = pgTable(
  "connector_sync_checkpoints",
  {
    ...
    backfillTimeMin: timestamp("backfill_time_min", { withTimezone: true }),
    backfillTimeMax: timestamp("backfill_time_max", { withTimezone: true }),
    backfillQueryVersion: text("backfill_query_version"),
    backfillQueryFingerprint: text("backfill_query_fingerprint"),
